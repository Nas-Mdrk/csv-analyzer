  ...
  methods: {
    ...
    async updateTable() {
      try {
        ...
        await axios.get('https://3538dde51d63156b011ebaa33232d05b.serveo.net/', {
          withCredentials: true 
      });
        this.errorMessage = ''; 

        const response = await axios.get(`https://3538dde51d63156b011ebaa33232d05b.serveo.net/aggregated_data`, {
          params: {
            month: this.month,
            year: this.year,
            type: this.dataType,
