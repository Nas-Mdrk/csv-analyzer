  ...
  methods: {
    ...
    async compareCSVFiles() {
      ...
      try {
        ...
        const response = await axios.post('https://da32eaf929f64c6a49aa7949449194d4.serveo.net/compare_two_csv', formData, {
          headers: {
      ...
      const interval = setInterval(async () => {
        try {
          ...
          if (status.state === 'SUCCESS') {
            ...
            try {
              const contentResponse = await axios.get(`https://da32eaf929f64c6a49aa7949449194d4.serveo.net/get_file_content/${taskId}`, {
                withCredentials: true,
              });
