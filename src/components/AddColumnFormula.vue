...
export default {
  ...
  methods: {
    reloadPage(event) {
      ...
      window.location.href = 'https://c0a44c3a82db72b42e1f39b65877118c.serveo.net/add-columnformula'; // Redirige vers la nouvelle page
    ...
    async uploadFile() {
      ...
      try {
        ...
        const response = await axios.post('https://c0a44c3a82db72b42e1f39b65877118c.serveo.net/add_column_with_formula', formData, {
          headers: {
