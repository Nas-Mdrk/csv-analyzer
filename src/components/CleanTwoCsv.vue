  ...
  methods: {
    ...
    async uploadFiles() {
      ...
      try {
        ...
        const response = await axios.post('https://da32eaf929f64c6a49aa7949449194d4.serveo.net/clean_two_csv', formData, {
          headers: {
        ...
        const interval = setInterval(async () => {
          try {
            ...
            if (status.state === 'SUCCESS') {
              ...
              this.downloadUrl = `https://da32eaf929f64c6a49aa7949449194d4.serveo.net/download_cleaned_csv/${taskId}`;
