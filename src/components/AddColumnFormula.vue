...
export default {
  ...
  methods: {
    reloadPage(event) {
      ...
      window.location.href = 'https://a0a199a3a42d7975642506c97149fb1b.serveo.net/add-columnformula'; // Redirige vers la nouvelle page
    ...
    async uploadFile() {
      ...
      try {
        ...
        const response = await axios.post('https://a0a199a3a42d7975642506c97149fb1b.serveo.net/add_column_with_formula', formData, {
          headers: {
        ...
        const interval = setInterval(async () => {
          try {
            const statusResponse = await axios.get(`https://a0a199a3a42d7975642506c97149fb1b.serveo.net/task_status/${taskId}`, {
              withCredentials: true, // Inclure les cookies
            });
            ...
            if (status.state === 'SUCCESS') {
              ...
              this.downloadUrl = `https://a0a199a3a42d7975642506c97149fb1b.serveo.net/download_clean_csv/${taskId}`;
