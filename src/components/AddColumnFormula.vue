...
export default {
  ...
  methods: {
    reloadPage(event) {
      ...
      window.location.href = 'https://65a1069185f442d5e5b82ffe0651c864.serveo.net/add-columnformula'; // Redirige vers la nouvelle page
    ...
    async uploadFile() {
      ...
      try {
        await axios.get('https://65a1069185f442d5e5b82ffe0651c864.serveo.net/', {
          withCredentials: true
        });
        // Envoyer le fichier au backend
        const response = await axios.post('https://65a1069185f442d5e5b82ffe0651c864.serveo.net/add_column_with_formula', formData, {
          headers: {
        ...
        const interval = setInterval(async () => {
          try {
            const statusResponse = await axios.get(`https://65a1069185f442d5e5b82ffe0651c864.serveo.net/task_status/${taskId}`, {
              withCredentials: true, // Inclure les cookies
            });
            ...
            if (status.state === 'SUCCESS') {
              ...
              this.downloadUrl = `https://65a1069185f442d5e5b82ffe0651c864.serveo.net/download_clean_csv/${taskId}`;
