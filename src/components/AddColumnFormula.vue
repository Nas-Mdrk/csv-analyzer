...
export default {
  ...
  methods: {
    reloadPage(event) {
      ...
      window.location.href = '/add-columnformula'; // Redirige vers la nouvelle page
    ...
    async uploadFile() {
      ...
      try {
        ...
        const response = await axios.post('https://back-csv-analyzer-production.up.railway.app/add_column_with_formula', formData, {
          headers: {
