  ...
  methods: {
    ...
    async compareCSVFiles() {
      ...
      try {
        ...
        const response = await axios.post('https://bffff56dda3a56d68b03fe16bffb7d11.serveo.net/compare_two_csv', formData, {
          headers: {
      ...
      const interval = setInterval(async () => {
        try {
          ...
          if (status.state === 'SUCCESS') {
            ...
            try {
              const contentResponse = await axios.get(`https://bffff56dda3a56d68b03fe16bffb7d11.serveo.net/get_file_content/${taskId}`, {
                withCredentials: true,
              });
