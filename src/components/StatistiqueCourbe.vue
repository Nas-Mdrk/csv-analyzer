      ...
      <div class="col-md-8">
        <div class="statistics card p-4">
          <div class="form-group">
            ...
            <h6><label for="interval">Cet outil vous offre un aperçu graphique des résultats obtenus. </label></h6>
            <br>
...
export default {
  ...
  methods: {
    async fetchData() {
      this.errorMessage = '';
      try {
        const response = await axios.post('https://back-csv-analyzer-production.up.railway.app/mouvementpercentage', {
